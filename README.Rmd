...
# powsim_RData
This repository contains count matrices of published RNA-seq experiments (xx_cnts.rda) and estimated negative binomial parameters as exemplaric input to powsim (xx_estparam.rda).
